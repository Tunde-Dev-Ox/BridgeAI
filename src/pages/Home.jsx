...
const FAQS = [
  {
    q: "What is Goover?",
    a: "Goover is an AI-powered tool that helps African product managers translate their local market experience into language global hiring managers immediately understand. It analyzes your profile against any job description and delivers a fit score, experience translation, gap analysis, and tailored cover letter.",
  },
  {
  ...
  },
  {
    ...
    a: "Goover is built for African product managers who want to take their careers global. But, it can also be used by other tech professionals from emerging markets who want to take their careers global.",
  }
];
        ...
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="px-5 py-2 bg-brand text-white text-sm font-semibold rounded-[4px] hover:bg-brand/80 transition-all active:scale-[0.97] cursor-pointer"
            >
              Get Started
            </button>
          </div>
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight font-cabinet leading-[1.1] max-w-4xl mx-auto animate-fade-in">
            ...
            <br />
            <span className="text-[#533afd]">Global companies</span> just don't see it yet.
          </h1>
          ...
          <div className="mt-8 flex items-center justify-center gap-4 animate-fade-in max-[540px]:flex-col" style={{ animationDelay: "0.3s" }}>
            <button
              onClick={openAuthModal}
              className="px-6 py-3 bg-brand text-white font-semibold rounded-[4px] hover:bg-brand/80 transition-all flex items-center gap-2 text-sm active:scale-[0.97] cursor-pointer"
            >
              Try Goover Free
            ...
            <a
              href="#how-it-works"
              className="px-6 py-3 border border-[#533afd] text-[#533afd] font-semibold rounded-[4px] hover:border-[#533afd]/80 transition-all text-sm active:scale-[0.97]"
            >
              See How It Works
            </a>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {STEPS.map((step, i) => (
                <div key={step.num} className="text-center group">
                  <div className="w-12 h-12 rounded-xl bg-[#533afd]/10 text-brand font-bold text-lg flex items-center justify-center mx-auto mb-4 font-cabinet">
                    {step.num}
                  </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {FEATURES.map(({ icon: Icon, title, desc }, i) => (
                <div key={title} className="border border-zinc-200 rounded-xl p-6 hover:border-zinc-300 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 group">
                  <div className="w-10 h-10 rounded-lg bg-[#533afd]/10 flex items-center justify-center mb-4">
          ...
          <ScrollReveal>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="mt-3 text-zinc-400 max-w-lg mx-auto">
                Thousands of African PMs are already using Goover to land global roles. Start your journey today.
              </p>
              <Link
                to="/app"
                className="mt-8 inline-flex px-6 py-3 bg-brand text-white font-semibold rounded-[4px] hover:bg-brand/80 transition-all items-center gap-2 text-sm active:scale-[0.97]"
              >
                Get Started Free
      ...
      <footer className="bg-white border-t border-zinc-100">
        <div className="max-w-6xl mx-auto px-6 py-14">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-9 h-9 rounded-lg border border-zinc-200 flex items-center justify-center text-zinc-500 hover:text-[#533afd] hover:border-[#533afd]/30 hover:bg-[#533afd]/5 transition-all">
                  <FiLinkedin className="w-4 h-4" />
                </a>
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="w-9 h-9 rounded-lg border border-zinc-200 flex items-center justify-center text-zinc-500 hover:text-[#533afd] hover:border-[#533afd]/30 hover:bg-[#533afd]/5 transition-all">
                  <FiTwitter className="w-4 h-4" />
                </a>
                <a href="https://discord.com" target="_blank" rel="noopener noreferrer" aria-label="Discord" className="w-9 h-9 rounded-lg border border-zinc-200 flex items-center justify-center text-zinc-500 hover:text-[#533afd] hover:border-[#533afd]/30 hover:bg-[#533afd]/5 transition-all">
          ...
          <div className="mt-10 pt-6 border-t border-zinc-100 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-sm text-zinc-600">&copy; {new Date().getFullYear()} Goover. All rights reserved.</p>
            <p className="text-sm text-zinc-600">Built by <a href="https://www.linkedin.com/in/josephtunde/" target="_blank" className="text-[#533afd] hover:text-[#533afd]/80 transition-colors underline">Joseph Tunde</a> for Mind The Product World Product Day 2026</p>
          </div>
        </div>
      </footer>
    </div>
