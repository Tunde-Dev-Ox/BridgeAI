...
// Security Helper: Basic HTML sanitization
...
export default function Profile() {
  ...
  // Keyboard Escape Handler for inline edits
  useEffect(() => {
  ...
  // Load profile data from Supabase on mount / auth change
  useEffect(() => {
  ...
  const handleFileChange = useCallback(async (e) => {
    ...
    // Security: Validate File Size (2MB) and Type
  ...
  return (
    <div className="grid h-screen grid-cols-1 md:grid-cols-[192px_1fr] text-zinc-950 bg-white">
      <Sidebar />
      <main className="relative mx-auto flex w-full max-w-7xl flex-1 flex-col overflow-y-auto px-4 py-6 sm:px-10 sm:py-10 pb-20 md:pb-10" style={{ scrollbarWidth: "none", WebkitScrollbarWidth: "none", msOverflowStyle: "none" }}>
